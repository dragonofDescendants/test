		...
		<el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign" 
            ...
            <el-table-column width="300" :align="contents.tableAlign" 
               :header-align="contents.tableAlign"
                ...
                <el-button v-if="isAuth('orders'+'/'+orderStatus,'核销') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="primary" icon="el-icon-edit" size="mini" @click="writeOff(scope.row)">{{ contents.tableBtnFont == 1?'核销':'' }}</el-button>
                <el-button v-if="isAuth('orders'+'/'+orderStatus,'核销') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="primary" size="mini" @click="writeOff(scope.row)">{{ contents.tableBtnFont == 1?'核销':'' }}<i class="el-icon-edit el-icon--right" /></el-button>
                <el-button v-if="isAuth('orders'+'/'+orderStatus,'核销') && contents.tableBtnIcon == 0" type="primary" size="mini" @click="writeOff(scope.row)">{{ contents.tableBtnFont == 1?'核销':'' }}</el-button>
